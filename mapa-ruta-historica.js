...
const puntsRuta = [
  [38.2906, -0.4953, 'Castell de Santa Bàrbara', 'Fortalesa d’origen àrab amb vistes panoràmiques.', '🏰'],
  [38.2919, -0.4933, 'Barri de Santa Creu', 'Carrers estrets, flors i essència medieval.', '🌸'],
  ...
  [38.3441, -0.4849, 'Concatedral de Sant Nicolau', 'Cúpula blava i estil renaixentista.', '⛪'],
  [38.3444, -0.4821, 'La Rambla de Méndez Núñez', 'Eix divisori entre el casc antic i l’eixample.', '🛣️'],
  [38.3473, -0.4827, 'Portal d’Elx', 'Accés històric amb arbres centenaris i bancs modernistes.', '🌳'],
  ...
  [38.3450, -0.4793, 'Plaça de l’Ajuntament', 'Edifici barroc, escala noble i sala daurada.', '🏛️'],
